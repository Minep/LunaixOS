#include "_null.h"
/********************************************************
*		  Lunaix Kernel - Luna C++ Runtime
*				Copyright Lunaixsky
*		Compilier copyright (c) Microsoft VC++
*********************************************************/
//! Luna C++ runtime
// 因为目前还处在开发阶段，我们必须用MSVC++的编译器来制作我们的Luna C++ RTL
// Very MSVC++ dependent. Will try to support different compiliers later.

#ifndef _MSC_VER
#error "Lunaix Kernel C++ Runtime requires Microsoft Visual C++ 2005 or later."
#endif
